class CfgWeapons
{
    ...
    NEW_VEST_M43A_Light(Black,TFBravo)
    NEW_VEST_M43A_BaseSec(Black,TFBravo)
    NEW_VEST_M43A_GungnirL(Black,TFBravo)
    NEW_VEST_M43A_GungnirS(Black,TFBravo)
    ...
    NEW_VEST_M43A_Light(Brown,TFBravo)
    NEW_VEST_M43A_BaseSec(Brown,TFBravo)
    NEW_VEST_M43A_GungnirL(Brown,TFBravo)
    NEW_VEST_M43A_GungnirS(Brown,TFBravo)
    ...
    NEW_VEST_M43A_Light(Green,TFBravo)
    NEW_VEST_M43A_BaseSec(Green,TFBravo)
    NEW_VEST_M43A_GungnirL(Green,TFBravo)
    NEW_VEST_M43A_GungnirS(Green,TFBravo)
    ...
    NEW_VEST_M43A_Light(Olive,TFBravo)
    NEW_VEST_M43A_BaseSec(Olive,TFBravo)
    NEW_VEST_M43A_GungnirL(Olive,TFBravo)
    NEW_VEST_M43A_GungnirS(Olive,TFBravo)
    ...
    NEW_VEST_M43A_Light(Tan,TFBravo)
    NEW_VEST_M43A_BaseSec(Tan,TFBravo)
    NEW_VEST_M43A_GungnirL(Tan,TFBravo)
    NEW_VEST_M43A_GungnirS(Tan,TFBravo)
    ...
    NEW_VEST_M43A_Light(White,TFBravo)
    NEW_VEST_M43A_BaseSec(White,TFBravo)
    NEW_VEST_M43A_GungnirL(White,TFBravo)
    NEW_VEST_M43A_GungnirS(White,TFBravo)
    ...
    NEW_VEST_M43D_ODST(Black,TFBravo)
    NEW_VEST_M43D_Breacher(Black,TFBravo)
    NEW_VEST_M43D_Sharpshooter(Black,TFBravo)
    NEW_VEST_M43D_Light(Black,TFBravo)
    ...
    HELMET_ECH55D(TFBravo)
    HELMET_CH43A(TFBravo)
    HELMET_ECH43A(TFBravo)
    HELMET_ECH35J(TFBravo)
};
